...
<div class="panel admin-panel">
    <div class="panel-head">
        <strong><span class="icon-table"></span> 领队统计</strong>
        <form:form id="searchForm"  action="${ctx}/admin/totalCount/showDataCountLeaders" method="post">
    ...
    <table class="table table-hover text-center">
        ...
        <c:forEach items="${pageInfo.list}" var="leader" varStatus="status">
            <tr>
                ...
                <td><img src="${leader.headImgUrl}" alt=""></td>
