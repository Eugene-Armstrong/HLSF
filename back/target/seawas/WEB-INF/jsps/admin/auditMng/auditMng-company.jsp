...
<div class="panel admin-panel">
    <div class="panel-head">
        <strong><span class="icon-check-square-o"></span> 团队定制</strong>
    ...
    <table id="todo" class="table table-hover text-center">
        ...
        <c:if test="${customs.list != []}">
            ...
            <c:forEach items="${customs.list}" var="custom" varStatus="status">
                <tr>
    ...
    <div class="page-btn">
        <ul class="pagination">
            ...
            <c:if test="${!customs.isFirstPage}">
                <li><a href="${ctx}/admin/audit/company?pageNumber1=1&pageSize1=${customs.pageSize}">首页</a></li>
                <li><a href="${ctx}/admin/audit/company?pageNumber1=${customs.prePage}&pageSize1=${customs.pageSize}">上一页</a></li>
            </c:if>
            <c:forEach items="${customs.navigatepageNums}" var="navigatepageNum1">
                <c:if test="${navigatepageNum1==customs.pageNum}">
                    <li class="active"><a href="${ctx}/admin/audit/company?pageNumber1=${navigatepageNum1}&pageSize1=${customs.pageSize}">${navigatepageNum1}</a></li>
                </c:if>
                <c:if test="${navigatepageNum1!=customs.pageNum}">
                    <li><a href="${ctx}/admin/audit/company?pageNumber1=${navigatepageNum1}&pageSize1=${customs.pageSize}">${navigatepageNum1}</a></li>
                </c:if>
            </c:forEach>
            <c:if test="${!customs.isLastPage}">
                <li><a href="${ctx}/admin/audit/company?pageNumber1=${customs.nextPage}&pageSize1=${customs.pageSize}">下一页</a></li>
                <li><a href="${ctx}/admin/audit/company?pageNumber1=${customs.pages}&pageSize1=${customs.pageSize}">最后一页</a></li>
            </c:if>
        </ul>
    </div>
    ...
    <div class="page-btn">
        <ul class="pagination">
            ...
            <c:if test="${!passCustoms.isFirstPage}">
                <li><a href="${ctx}/admin/audit/company?pageNumber2=1&pageSize2=${passCustoms.pageSize}">首页</a></li>
                <li><a href="${ctx}/admin/audit/company?pageNumber2=${passCustoms.prePage}&pageSize2=${passCustoms.pageSize}">上一页</a></li>
            </c:if>
            <c:forEach items="${passCustoms.navigatepageNums}" var="navigatepageNum2">
                <c:if test="${navigatepageNum2==passCustoms.pageNum}">
                    <li class="active"><a href="${ctx}/admin/audit/company?pageNumber2=${navigatepageNum2}&pageSize2=${passCustoms.pageSize}">${navigatepageNum2}</a></li>
                </c:if>
                <c:if test="${navigatepageNum2!=passCustoms.pageNum}">
                    <li><a href="${ctx}/admin/audit/company?pageNumber2=${navigatepageNum2}&pageSize2=${passCustoms.pageSize}">${navigatepageNum2}</a></li>
                </c:if>
            </c:forEach>
            <c:if test="${!passCustoms.isLastPage}">
                <li><a href="${ctx}/admin/audit/company?pageNumber2=${passCustoms.nextPage}&pageSize2=${passCustoms.pageSize}">下一页</a></li>
                <li><a href="${ctx}/admin/audit/company?pageNumber2=${passCustoms.pages}&pageSize2=${passCustoms.pageSize}">最后一页</a></li>
            </c:if>
        </ul>
    </div>
    ...
    <table id="fail" class="table table-hover text-center">
        ...
        <tr>
            <td class="ckb"><input type="checkbox"></td>
            <td>${un.user.nickName}</td>
            <td>${un.name}</td>
            <td>${un.manaName}</td>
            <td>${un.manaTel}</td>
            <td><fmt:formatDate value="${un.createTime}" pattern="yyyy-MM-dd HH:mm"/></td>
            <td><a href="${ctx}/admin/audit/company/detail?customId=${un.id}">详情</a></td>
    ...
    <div class="page-btn">
        <ul class="pagination">
            ...
            <c:if test="${!unpassCustoms.isFirstPage}">
                <li><a href="${ctx}/admin/audit/company?pageNumber3=1&pageSize3=${unpassCustoms.pageSize}">首页</a></li>
                <li><a href="${ctx}/admin/audit/company?pageNumber3=${unpassCustoms.prePage}&pageSize3=${unpassCustoms.pageSize}">上一页</a></li>
            </c:if>
            <c:forEach items="${unpassCustoms.navigatepageNums}" var="navigatepageNum3">
                <c:if test="${navigatepageNum3==unpassCustoms.pageNum}">
                    <li class="active"><a href="${ctx}/admin/audit/company?pageNumber3=${navigatepageNum3}&pageSize3=${unpassCustoms.pageSize}">${navigatepageNum3}</a></li>
                </c:if>
                <c:if test="${navigatepageNum3!=unpassCustoms.pageNum}">
                    <li><a href="${ctx}/admin/audit/company?pageNumber3=${navigatepageNum3}&pageSize3=${unpassCustoms.pageSize3}">${navigatepageNum3}</a></li>
                </c:if>
            </c:forEach>
            <c:if test="${!unpassCustoms.isLastPage}">
                <li><a href="${ctx}/admin/audit/company?pageNumber3=${unpassCustoms.nextPage}&pageSize3=${unpassCustoms.pageSize}">下一页</a></li>
                <li><a href="${ctx}/admin/audit/company?pageNumber3=${unpassCustoms.pages}&pageSize3=${unpassCustoms.pageSize}">最后一页</a></li>
            </c:if>
        </ul>
    </div>
    ...
    <div id="reject">
        <div class="dialog">
            ...
            <div class="dialog-foot">
                <button class="button bg-green dialog-close" onclick="sendReason()">
                    发送</button>
        ...
        $("a[href='#yes']").click(function () {
            ...
            if (intL != 0) { // 如果有选中项
                $("input[type=checkbox]").each(function (index) { // 遍历全部复选框的行
                    ...
                    type:'post',
                    url: "${ctx}/admin/audit/company/deleteCustoms", // 请求处理页
                    dataType: "html",
