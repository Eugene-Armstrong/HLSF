...
<div class="panel admin-panel">
    <div class="panel-head">
        <strong><span class="icon-table"></span> 产品数量统计</strong>
        <form:form id ="searchForm" action="${ctx}/admin/totalCount/showDataCountProduct" method="post" modelAttribute="city">
