...
<div class="panel admin-panel">
    <div class="panel-head">
        <strong><span class="icon-table"></span> 总成交金额统计</strong>
        <a href="${ctx}/admin/totalCount/showTotalCount" class="button border-blue float-right">返回</a>
        <form:form id ="searchForm" action="${ctx}/admin/totalCount/showDataCountTotalMoney" method="post">
    ...
    <table class="table table-hover text-center">
        ...
        <c:forEach items="${pageInfo.list}" var="user" varStatus="status">
            <tr>
                ...
                <td>${user.nickName}</td>
                <td>
                    <fmt:formatNumber value="${user.volPrice * 0.01}" pattern="0.##"/>
                </td>
            </tr>
        </c:forEach>
    </table>
